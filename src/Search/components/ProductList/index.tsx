    ...
    <StyledProductL>
      <div className="container_product">
        {GPUCard.gpuList.map((e, i) => {
          const cashPrice = (Number(e.price.replace(",", ".")) * 0.9).toFixed(2);
          const installmentPrice = (Number(e.price.replace(",", ".")) / 12).toFixed(2);
          return (
            <div className="container_cardGpu" key={i}>
              ...
              <div className="frame_content">
                ...
                <span>
                  ...
                  <p className="small2">
                    {" "}
                    em até 12X de R$ {installmentPrice.replace(".", ",")} sem juros
                  </p>
                </span>
              </div>
            </div>
